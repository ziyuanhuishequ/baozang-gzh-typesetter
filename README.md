...
### 实时保存按钮和暂存按钮
软件的上方有个实时同步的按钮，点击开启后，选择保存路径，软件会自动对文章进行同步，绿灯就是开启状态，红灯就是关闭状态，还支持暂存文章保存的文章会在草稿管理里出现，如果误删了，点击可以恢复当前文章
<img width="292" height="47" alt="29f295065a030ae8865412e553ee495a" src="https://github.com/user-attachments/assets/fcfdd260-a447-4f1e-a62e-d304d6ba0f7f" />
<img width="801" height="431" alt="05c6d8d52e06e46e3023aca1dbd40597" src="https://github.com/user-attachments/assets/0dacea06-dd06-4a28-a26a-af928e29c1fd" />
